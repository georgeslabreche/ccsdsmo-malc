...
// structure definition for composite mc_alert_alertevent
struct _mc_alert_alertevent_t {
  mc_argumentvalue_list_t * f_argumentvalues;
...
{
  mc_alert_alertevent_t *self = (mc_alert_alertevent_t *) calloc(1, sizeof(mc_alert_alertevent_t));
  if (!self)
    return NULL;
  return self;
}
...
int mc_alert_alertevent_add_encoding_length_malbinary(mc_alert_alertevent_t * self, mal_encoder_t * encoder, void * cursor)
{
  ...
  {
    rc = mc_argumentvalue_list_add_encoding_length_malbinary(self->f_argumentvalues, encoder, cursor);
    if (rc < 0)
      return rc;
  }
...
int mc_alert_alertevent_encode_malbinary(mc_alert_alertevent_t * self, mal_encoder_t * encoder, void * cursor)
{
  ...
  if (presence_flag)
  {
    rc = mc_argumentvalue_list_encode_malbinary(self->f_argumentvalues, encoder, cursor);
    if (rc < 0)
      return rc;
  }
...
int mc_alert_alertevent_decode_malbinary(mc_alert_alertevent_t * self, mal_decoder_t * decoder, void * cursor)
{
  ...
  if (presence_flag)
  {
    self->f_argumentvalues = mc_argumentvalue_list_new(0);
    if (self->f_argumentvalues == NULL) return -1;
    rc = mc_argumentvalue_list_decode_malbinary(self->f_argumentvalues, decoder, cursor);
    if (rc < 0)
      return rc;
  }
  else
...
void mc_alert_alertevent_destroy(mc_alert_alertevent_t ** self_p)
{
  ...
  {
    mc_argumentvalue_list_destroy(& (*self_p)->f_argumentvalues);
  }
