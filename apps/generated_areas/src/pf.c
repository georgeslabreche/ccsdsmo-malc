...
int PF_CAMERA_PICTUREFORMAT_NUMERIC_VALUES[] =
{
  1,
  2,
  3,
...
int pf_camera_picturesstream_update_add_encoding_length_0(mal_encoder_t * encoder, pf_camera_picture_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = pf_camera_picture_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_picturesstream_update_encode_0(void * cursor, mal_encoder_t * encoder, pf_camera_picture_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_camera_picture_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_picturesstream_update_decode_0(void * cursor, mal_decoder_t * decoder, pf_camera_picture_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_camera_picture_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_camera_picture_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_camera_picturesstream_update_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  rc = pf_camera_picturesstream_update_decode_0(cursor, decoder, (void*)&value.composite_value);
  ...
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_PICTURE_LIST_SHORT_FORM);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_PICTURESSTREAM_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_REGISTER);
...
int pf_camera_picturesstream_register_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  rc = pf_camera_picturesstream_register(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_PICTURESSTREAM_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_REGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_PICTURESSTREAM_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH);
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_PICTURESSTREAM_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
int pf_camera_picturesstream_deregister_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_picturesstream_deregister(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_PICTURESSTREAM_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_ENABLESTREAM_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
...
int pf_camera_enablestream_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_camera_enablestream_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
...
int pf_camera_enablestream_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_camera_enablestream_submit_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
...
int pf_camera_enablestream_submit_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_enablestream_submit_decode_2(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int pf_camera_enablestream_submit_add_encoding_length_3(mal_encoder_t * encoder, pf_camera_camerasettings_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_camera_camerasettings_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_enablestream_submit_encode_3(void * cursor, mal_encoder_t * encoder, pf_camera_camerasettings_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_camera_camerasettings_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_enablestream_submit_decode_3(void * cursor, mal_decoder_t * decoder, pf_camera_camerasettings_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_camera_camerasettings_new();
        if (*element_res == NULL) return -1;
        rc = pf_camera_camerasettings_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_camera_enablestream_submit_decode_3_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_enablestream_submit_decode_3(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_CAMERASETTINGS_SHORT_FORM);
  return rc;
}
...
int pf_camera_enablestream_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2, mal_element_holder_t * arg3)
{
  ...
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_enablestream_submit_add_encoding_length_0(encoder,true,arg0->value.boolean_value,cursor);
  } else {
    rc = pf_camera_enablestream_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_camera_enablestream_submit_add_encoding_length_1(encoder,true,arg1->value.duration_value,cursor);
  } else {
    rc = pf_camera_enablestream_submit_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_camera_enablestream_submit_add_encoding_length_2(encoder,arg2->value.identifier_value,cursor);
  } else {
    rc = pf_camera_enablestream_submit_add_encoding_length_2(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_camera_enablestream_submit_add_encoding_length_3(encoder,arg3->value.composite_value,cursor);
  } else {
    rc = pf_camera_enablestream_submit_add_encoding_length_3(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_enablestream_submit_encode_0(cursor,encoder,true,arg0->value.boolean_value);
  } else {
    rc = pf_camera_enablestream_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  ...
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_camera_enablestream_submit_encode_1(cursor,encoder,true,arg1->value.duration_value);
  } else {
    rc = pf_camera_enablestream_submit_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_camera_enablestream_submit_encode_2(cursor,encoder,arg2->value.identifier_value);
  } else {
    rc = pf_camera_enablestream_submit_encode_2(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_camera_enablestream_submit_encode_3(cursor,encoder,arg3->value.composite_value);
  } else {
    rc = pf_camera_enablestream_submit_encode_3(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_enablestream_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_ENABLESTREAM_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
...
int pf_camera_enablestream_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_enablestream_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int pf_camera_enablestream_error_add_encoding_length_pf_camera_pixelresolution_list(mal_encoder_t * encoder, pf_camera_pixelresolution_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_camera_pixelresolution_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_enablestream_error_encode_pf_camera_pixelresolution_list(void * cursor, mal_encoder_t * encoder, pf_camera_pixelresolution_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_camera_pixelresolution_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_enablestream_error_add_encoding_length_pf_camera_pictureformat_list(mal_encoder_t * encoder, pf_camera_pictureformat_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_camera_pictureformat_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_enablestream_error_encode_pf_camera_pictureformat_list(void * cursor, mal_encoder_t * encoder, pf_camera_pictureformat_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_camera_pictureformat_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_enablestream_error_decode(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_malbinary_decode_mal_element(decoder, cursor, element_holder);
        if (rc < 0)
          return rc;
      }
      mal_element_holder_set_presence_flag(element_holder, presence_flag);
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_PREVIEWPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_camera_previewpicture_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_previewpicture_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_PREVIEWPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_camera_previewpicture_request_response_add_encoding_length_0(mal_encoder_t * encoder, pf_camera_picture_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_camera_picture_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_previewpicture_request_response_encode_0(void * cursor, mal_encoder_t * encoder, pf_camera_picture_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_camera_picture_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_camera_previewpicture_request_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_camera_picture_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_camera_picture_new();
        if (*element_res == NULL) return -1;
        rc = pf_camera_picture_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_camera_previewpicture_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_previewpicture_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_PICTURE_SHORT_FORM);
  return rc;
}
...
int pf_camera_previewpicture_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_previewpicture_request_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_camera_previewpicture_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_previewpicture_request_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_camera_previewpicture_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_previewpicture_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_TAKEPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_camera_takepicture_invoke_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_takepicture_invoke_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_CAMERASETTINGS_SHORT_FORM);
  return rc;
...
int pf_camera_takepicture_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takepicture_invoke_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_camera_takepicture_invoke_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takepicture_invoke_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_camera_takepicture_invoke_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_takepicture_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_TAKEPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_camera_takepicture_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_takepicture_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_TAKEPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_camera_takepicture_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_takepicture_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_PICTURE_SHORT_FORM);
  return rc;
...
int pf_camera_takepicture_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takepicture_invoke_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_camera_takepicture_invoke_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takepicture_invoke_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_camera_takepicture_invoke_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_takepicture_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_TAKEAUTOEXPOSEDPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_camera_takeautoexposedpicture_invoke_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_takeautoexposedpicture_invoke_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_CAMERASETTINGS_SHORT_FORM);
  return rc;
...
int pf_camera_takeautoexposedpicture_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takeautoexposedpicture_invoke_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_camera_takeautoexposedpicture_invoke_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takeautoexposedpicture_invoke_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_camera_takeautoexposedpicture_invoke_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_takeautoexposedpicture_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_TAKEAUTOEXPOSEDPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_camera_takeautoexposedpicture_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_takeautoexposedpicture_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_TAKEAUTOEXPOSEDPICTURE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_camera_takeautoexposedpicture_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_takeautoexposedpicture_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_PICTURE_SHORT_FORM);
  return rc;
...
int pf_camera_takeautoexposedpicture_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takeautoexposedpicture_invoke_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_camera_takeautoexposedpicture_invoke_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_takeautoexposedpicture_invoke_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_camera_takeautoexposedpicture_invoke_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_takeautoexposedpicture_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_GETPROPERTIES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_camera_getproperties_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_getproperties_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_CAMERA_SERVICE_NUMBER, PF_CAMERA_GETPROPERTIES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_camera_getproperties_request_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_camera_pixelresolution_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_camera_pixelresolution_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_camera_pixelresolution_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_camera_getproperties_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_getproperties_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_PIXELRESOLUTION_LIST_SHORT_FORM);
  return rc;
}
...
int pf_camera_getproperties_request_response_decode_1(void * cursor, mal_decoder_t * decoder, pf_camera_pictureformat_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_camera_pictureformat_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_camera_pictureformat_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_camera_getproperties_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_getproperties_request_response_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_CAMERA_PICTUREFORMAT_LIST_SHORT_FORM);
  return rc;
}
...
int pf_camera_getproperties_request_response_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_camera_getproperties_request_response_decode_2(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int pf_camera_getproperties_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_getproperties_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_camera_getproperties_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_camera_getproperties_request_response_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = pf_camera_getproperties_request_response_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_camera_getproperties_request_response_add_encoding_length_2(encoder,arg2->value.string_value,cursor);
  } else {
    rc = pf_camera_getproperties_request_response_add_encoding_length_2(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_camera_getproperties_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_camera_getproperties_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_camera_getproperties_request_response_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = pf_camera_getproperties_request_response_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_camera_getproperties_request_response_encode_2(cursor,encoder,arg2->value.string_value);
  } else {
    rc = pf_camera_getproperties_request_response_encode_2(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_camera_getproperties_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETNMEASENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_getnmeasentence_invoke_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getnmeasentence_invoke_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_STRING_SHORT_FORM);
  return rc;
...
int pf_gps_getnmeasentence_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getnmeasentence_invoke_add_encoding_length_0(encoder,arg0->value.string_value,cursor);
  } else {
    rc = pf_gps_getnmeasentence_invoke_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getnmeasentence_invoke_encode_0(cursor,encoder,arg0->value.string_value);
  } else {
    rc = pf_gps_getnmeasentence_invoke_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getnmeasentence_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETNMEASENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getnmeasentence_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getnmeasentence_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETNMEASENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getnmeasentence_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getnmeasentence_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_STRING_SHORT_FORM);
  return rc;
...
int pf_gps_getnmeasentence_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getnmeasentence_invoke_response_add_encoding_length_0(encoder,arg0->value.string_value,cursor);
  } else {
    rc = pf_gps_getnmeasentence_invoke_response_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getnmeasentence_invoke_response_encode_0(cursor,encoder,arg0->value.string_value);
  } else {
    rc = pf_gps_getnmeasentence_invoke_response_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getnmeasentence_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETLASTKNOWNPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_getlastknownposition_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getlastknownposition_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETLASTKNOWNPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getlastknownposition_request_response_add_encoding_length_0(mal_encoder_t * encoder, pf_gps_position_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_gps_position_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getlastknownposition_request_response_encode_0(void * cursor, mal_encoder_t * encoder, pf_gps_position_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_gps_position_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getlastknownposition_request_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_gps_position_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_gps_position_new();
        if (*element_res == NULL) return -1;
        rc = pf_gps_position_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_gps_getlastknownposition_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getlastknownposition_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_GPS_POSITION_SHORT_FORM);
  return rc;
}
...
int pf_gps_getlastknownposition_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_gps_getlastknownposition_request_response_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_gps_getlastknownposition_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getlastknownposition_request_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_gps_getlastknownposition_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_gps_getlastknownposition_request_response_add_encoding_length_1(encoder,true,arg1->value.duration_value,cursor);
  } else {
    rc = pf_gps_getlastknownposition_request_response_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getlastknownposition_request_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_gps_getlastknownposition_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_gps_getlastknownposition_request_response_encode_1(cursor,encoder,true,arg1->value.duration_value);
  } else {
    rc = pf_gps_getlastknownposition_request_response_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getlastknownposition_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_getposition_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getposition_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getposition_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getposition_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getposition_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getposition_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_GPS_POSITION_SHORT_FORM);
  return rc;
...
int pf_gps_getposition_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getposition_invoke_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_gps_getposition_invoke_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getposition_invoke_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_gps_getposition_invoke_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getposition_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETSATELLITESINFO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_getsatellitesinfo_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getsatellitesinfo_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETSATELLITESINFO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getsatellitesinfo_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getsatellitesinfo_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETSATELLITESINFO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getsatellitesinfo_invoke_response_add_encoding_length_0(mal_encoder_t * encoder, pf_gps_satelliteinfo_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_gps_satelliteinfo_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getsatellitesinfo_invoke_response_encode_0(void * cursor, mal_encoder_t * encoder, pf_gps_satelliteinfo_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_gps_satelliteinfo_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getsatellitesinfo_invoke_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_gps_satelliteinfo_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_gps_satelliteinfo_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_gps_satelliteinfo_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_gps_getsatellitesinfo_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getsatellitesinfo_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_GPS_SATELLITEINFO_LIST_SHORT_FORM);
  return rc;
}
...
int pf_gps_getsatellitesinfo_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getsatellitesinfo_invoke_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_gps_getsatellitesinfo_invoke_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getsatellitesinfo_invoke_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_gps_getsatellitesinfo_invoke_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getsatellitesinfo_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_LISTNEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_listnearbyposition_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_listnearbyposition_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int pf_gps_listnearbyposition_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_listnearbyposition_request_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_gps_listnearbyposition_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_listnearbyposition_request_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_gps_listnearbyposition_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_listnearbyposition_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_LISTNEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_listnearbyposition_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_listnearbyposition_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int pf_gps_listnearbyposition_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_listnearbyposition_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_gps_listnearbyposition_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_listnearbyposition_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_gps_listnearbyposition_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_listnearbyposition_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_ADDNEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_addnearbyposition_request_add_encoding_length_0(mal_encoder_t * encoder, pf_gps_nearbypositiondefinition_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_gps_nearbypositiondefinition_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_addnearbyposition_request_encode_0(void * cursor, mal_encoder_t * encoder, pf_gps_nearbypositiondefinition_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_gps_nearbypositiondefinition_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_addnearbyposition_request_decode_0(void * cursor, mal_decoder_t * decoder, pf_gps_nearbypositiondefinition_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_gps_nearbypositiondefinition_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_gps_nearbypositiondefinition_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_gps_addnearbyposition_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_addnearbyposition_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_GPS_NEARBYPOSITIONDEFINITION_LIST_SHORT_FORM);
  return rc;
}
...
int pf_gps_addnearbyposition_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_addnearbyposition_request_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_gps_addnearbyposition_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_addnearbyposition_request_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_gps_addnearbyposition_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_addnearbyposition_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_ADDNEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_addnearbyposition_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_addnearbyposition_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int pf_gps_addnearbyposition_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_addnearbyposition_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_gps_addnearbyposition_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_addnearbyposition_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_gps_addnearbyposition_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_addnearbyposition_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_REMOVENEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_removenearbyposition_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_removenearbyposition_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int pf_gps_removenearbyposition_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_removenearbyposition_submit_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_gps_removenearbyposition_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_removenearbyposition_submit_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_gps_removenearbyposition_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_removenearbyposition_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_REMOVENEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_removenearbyposition_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_removenearbyposition_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_nearbyposition_update_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_nearbyposition_update_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_NEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_REGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
int pf_gps_nearbyposition_register_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_nearbyposition_register(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_NEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_REGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_NEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH);
  mal_message_set_transaction_id(message, initial_publish_register_tid);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, false);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_NEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
int pf_gps_nearbyposition_deregister_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_nearbyposition_deregister(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_NEARBYPOSITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETBESTXYZSENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_getbestxyzsentence_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getbestxyzsentence_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETBESTXYZSENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getbestxyzsentence_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getbestxyzsentence_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETBESTXYZSENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getbestxyzsentence_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getbestxyzsentence_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_STRING_SHORT_FORM);
  return rc;
...
int pf_gps_getbestxyzsentence_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getbestxyzsentence_invoke_response_add_encoding_length_0(encoder,arg0->value.string_value,cursor);
  } else {
    rc = pf_gps_getbestxyzsentence_invoke_response_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getbestxyzsentence_invoke_response_encode_0(cursor,encoder,arg0->value.string_value);
  } else {
    rc = pf_gps_getbestxyzsentence_invoke_response_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getbestxyzsentence_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETTIMEASENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_gettimeasentence_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_gettimeasentence_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETTIMEASENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_gettimeasentence_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_gettimeasentence_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETTIMEASENTENCE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_gettimeasentence_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_gettimeasentence_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_STRING_SHORT_FORM);
  return rc;
...
int pf_gps_gettimeasentence_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_gettimeasentence_invoke_response_add_encoding_length_0(encoder,arg0->value.string_value,cursor);
  } else {
    rc = pf_gps_gettimeasentence_invoke_response_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_gettimeasentence_invoke_response_encode_0(cursor,encoder,arg0->value.string_value);
  } else {
    rc = pf_gps_gettimeasentence_invoke_response_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_gettimeasentence_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETLASTKNOWNPOSITIONANDVELOCITY_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_getlastknownpositionandvelocity_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getlastknownpositionandvelocity_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETLASTKNOWNPOSITIONANDVELOCITY_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_0(mal_encoder_t * encoder, pf_vectord3d_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_vectord3d_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getlastknownpositionandvelocity_request_response_encode_0(void * cursor, mal_encoder_t * encoder, pf_vectord3d_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_vectord3d_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getlastknownpositionandvelocity_request_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_vectord3d_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_vectord3d_new();
        if (*element_res == NULL) return -1;
        rc = pf_vectord3d_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_gps_getlastknownpositionandvelocity_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getlastknownpositionandvelocity_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORD3D_SHORT_FORM);
  return rc;
}
...
int pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_1(mal_encoder_t * encoder, pf_vectorf3d_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_vectorf3d_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getlastknownpositionandvelocity_request_response_encode_1(void * cursor, mal_encoder_t * encoder, pf_vectorf3d_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_vectorf3d_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_getlastknownpositionandvelocity_request_response_decode_1(void * cursor, mal_decoder_t * decoder, pf_vectorf3d_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_vectorf3d_new();
        if (*element_res == NULL) return -1;
        rc = pf_vectorf3d_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_gps_getlastknownpositionandvelocity_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getlastknownpositionandvelocity_request_response_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORF3D_SHORT_FORM);
  return rc;
}
...
int pf_gps_getlastknownpositionandvelocity_request_response_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getlastknownpositionandvelocity_request_response_decode_2(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORD3D_SHORT_FORM);
  return rc;
...
int pf_gps_getlastknownpositionandvelocity_request_response_decode_3_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getlastknownpositionandvelocity_request_response_decode_3(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORF3D_SHORT_FORM);
  return rc;
...
int pf_gps_getlastknownpositionandvelocity_request_response_decode_4_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_gps_getlastknownpositionandvelocity_request_response_decode_4(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_gps_getlastknownpositionandvelocity_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2, mal_element_holder_t * arg3, mal_element_holder_t * arg4)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_1(encoder,arg1->value.composite_value,cursor);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_2(encoder,arg2->value.composite_value,cursor);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_2(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_3(encoder,arg3->value.composite_value,cursor);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_3(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg4
  if (arg4 != NULL && arg4->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_4(encoder,true,arg4->value.duration_value,cursor);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_add_encoding_length_4(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_1(cursor,encoder,arg1->value.composite_value);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_2(cursor,encoder,arg2->value.composite_value);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_2(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_3(cursor,encoder,arg3->value.composite_value);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_3(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg4
  if (arg4 != NULL && arg4->presence_flag) {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_4(cursor,encoder,true,arg4->value.duration_value);
  } else {
    rc = pf_gps_getlastknownpositionandvelocity_request_response_encode_4(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getlastknownpositionandvelocity_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETPOSITIONANDVELOCITY_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_getpositionandvelocity_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getpositionandvelocity_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETPOSITIONANDVELOCITY_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getpositionandvelocity_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getpositionandvelocity_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETPOSITIONANDVELOCITY_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_getpositionandvelocity_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getpositionandvelocity_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORD3D_SHORT_FORM);
  return rc;
...
int pf_gps_getpositionandvelocity_invoke_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getpositionandvelocity_invoke_response_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORF3D_SHORT_FORM);
  return rc;
...
int pf_gps_getpositionandvelocity_invoke_response_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getpositionandvelocity_invoke_response_decode_2(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORD3D_SHORT_FORM);
  return rc;
...
int pf_gps_getpositionandvelocity_invoke_response_decode_3_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_getpositionandvelocity_invoke_response_decode_3(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_VECTORF3D_SHORT_FORM);
  return rc;
...
int pf_gps_getpositionandvelocity_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2, mal_element_holder_t * arg3)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_1(encoder,arg1->value.composite_value,cursor);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_2(encoder,arg2->value.composite_value,cursor);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_2(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_3(encoder,arg3->value.composite_value,cursor);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_add_encoding_length_3(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_1(cursor,encoder,arg1->value.composite_value);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_2(cursor,encoder,arg2->value.composite_value);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_2(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_3(cursor,encoder,arg3->value.composite_value);
  } else {
    rc = pf_gps_getpositionandvelocity_invoke_response_encode_3(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_getpositionandvelocity_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETTLE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_gps_gettle_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_gettle_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETTLE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_gettle_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_gettle_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_GPS_SERVICE_NUMBER, PF_GPS_GETTLE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_gps_gettle_invoke_response_add_encoding_length_0(mal_encoder_t * encoder, pf_gps_twolineelementset_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_gps_twolineelementset_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_gettle_invoke_response_encode_0(void * cursor, mal_encoder_t * encoder, pf_gps_twolineelementset_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_gps_twolineelementset_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_gps_gettle_invoke_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_gps_twolineelementset_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_gps_twolineelementset_new();
        if (*element_res == NULL) return -1;
        rc = pf_gps_twolineelementset_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_gps_gettle_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_gps_gettle_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_GPS_TWOLINEELEMENTSET_SHORT_FORM);
  return rc;
}
...
int pf_gps_gettle_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_gettle_invoke_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_gps_gettle_invoke_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_gps_gettle_invoke_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_gps_gettle_invoke_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_gps_gettle_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int PF_AUTONOMOUSADCS_MAGNETORQUERSSTATE_NUMERIC_VALUES[] =
{
  1,
  2,
  3
...
int PF_AUTONOMOUSADCS_REACTIONWHEELIDENTIFIER_NUMERIC_VALUES[] =
{
  1,
  2,
  3,
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_0(mal_encoder_t * encoder, pf_autonomousadcs_attitudetelemetry_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = pf_autonomousadcs_attitudetelemetry_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_0(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudetelemetry_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_autonomousadcs_attitudetelemetry_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_decode_0(void * cursor, mal_decoder_t * decoder, pf_autonomousadcs_attitudetelemetry_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_autonomousadcs_attitudetelemetry_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_autonomousadcs_attitudetelemetry_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_autonomousadcs_monitorattitude_update_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_autonomousadcs_monitorattitude_update_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_AUTONOMOUSADCS_ATTITUDETELEMETRY_LIST_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_1(mal_encoder_t * encoder, pf_autonomousadcs_actuatorstelemetry_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = pf_autonomousadcs_actuatorstelemetry_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_1(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_actuatorstelemetry_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_autonomousadcs_actuatorstelemetry_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_decode_1(void * cursor, mal_decoder_t * decoder, pf_autonomousadcs_actuatorstelemetry_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_autonomousadcs_actuatorstelemetry_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_autonomousadcs_actuatorstelemetry_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_autonomousadcs_monitorattitude_update_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_autonomousadcs_monitorattitude_update_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_AUTONOMOUSADCS_ACTUATORSTELEMETRY_LIST_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_monitorattitude_update_decode_2(void * cursor, mal_decoder_t * decoder, mal_duration_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = mal_duration_list_new(0);
        if (*element_res == NULL) return -1;
        rc = mal_duration_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_autonomousadcs_monitorattitude_update_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_autonomousadcs_monitorattitude_update_decode_2(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_LIST_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3_pf_autonomousadcs_attitudemodebdot_list(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodebdot_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODEBDOT_LIST_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodebdot_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3_pf_autonomousadcs_attitudemodebdot_list(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodebdot_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODEBDOT_LIST_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodebdot_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3_pf_autonomousadcs_attitudemodenadirpointing_list(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodenadirpointing_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODENADIRPOINTING_LIST_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodenadirpointing_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3_pf_autonomousadcs_attitudemodenadirpointing_list(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodenadirpointing_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODENADIRPOINTING_LIST_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodenadirpointing_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3_pf_autonomousadcs_attitudemodesinglespinning_list(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesinglespinning_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODESINGLESPINNING_LIST_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesinglespinning_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3_pf_autonomousadcs_attitudemodesinglespinning_list(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesinglespinning_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODESINGLESPINNING_LIST_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesinglespinning_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3_pf_autonomousadcs_attitudemodesunpointing_list(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesunpointing_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODESUNPOINTING_LIST_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesunpointing_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3_pf_autonomousadcs_attitudemodesunpointing_list(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesunpointing_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODESUNPOINTING_LIST_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesunpointing_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3_pf_autonomousadcs_attitudemodetargettracking_list(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettracking_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKING_LIST_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettracking_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3_pf_autonomousadcs_attitudemodetargettracking_list(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettracking_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKING_LIST_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettracking_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3_pf_autonomousadcs_attitudemodetargettrackinglinear_list(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettrackinglinear_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKINGLINEAR_LIST_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettrackinglinear_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3_pf_autonomousadcs_attitudemodetargettrackinglinear_list(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettrackinglinear_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKINGLINEAR_LIST_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettrackinglinear_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3_pf_autonomousadcs_attitudemodevectorpointing_list(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodevectorpointing_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODEVECTORPOINTING_LIST_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodevectorpointing_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3_pf_autonomousadcs_attitudemodevectorpointing_list(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodevectorpointing_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODEVECTORPOINTING_LIST_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodevectorpointing_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_add_encoding_length_3(mal_encoder_t * encoder, mal_element_holder_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      {
        rc = pf_malbinary_add_mal_element_encoding_length(encoder, element, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_monitorattitude_update_encode_3(void * cursor, mal_encoder_t * encoder, mal_element_holder_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL && element->presence_flag))
      {
        rc = pf_malbinary_encode_mal_element(encoder, cursor, element);
        if (rc < 0)
          return rc;
      }
      break;
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_MONITORATTITUDE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_REGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
int pf_autonomousadcs_monitorattitude_register_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_monitorattitude_register(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_MONITORATTITUDE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_REGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_MONITORATTITUDE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH);
  mal_message_set_transaction_id(message, initial_publish_register_tid);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, false);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_MONITORATTITUDE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
int pf_autonomousadcs_monitorattitude_deregister_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_monitorattitude_deregister(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_MONITORATTITUDE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_ENABLEMONITORING_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_autonomousadcs_enablemonitoring_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_enablemonitoring_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_BOOLEAN_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_enablemonitoring_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_enablemonitoring_submit_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_enablemonitoring_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_enablemonitoring_submit_add_encoding_length_0(encoder,true,arg0->value.boolean_value,cursor);
  } else {
    rc = pf_autonomousadcs_enablemonitoring_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_enablemonitoring_submit_add_encoding_length_1(encoder,true,arg1->value.duration_value,cursor);
  } else {
    rc = pf_autonomousadcs_enablemonitoring_submit_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_enablemonitoring_submit_encode_0(cursor,encoder,true,arg0->value.boolean_value);
  } else {
    rc = pf_autonomousadcs_enablemonitoring_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_enablemonitoring_submit_encode_1(cursor,encoder,true,arg1->value.duration_value);
  } else {
    rc = pf_autonomousadcs_enablemonitoring_submit_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_enablemonitoring_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_ENABLEMONITORING_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_enablemonitoring_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_enablemonitoring_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_GETSTATUS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_autonomousadcs_getstatus_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_getstatus_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_GETSTATUS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_0(mal_encoder_t * encoder, pf_autonomousadcs_attitudetelemetry_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_autonomousadcs_attitudetelemetry_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_0(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudetelemetry_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_autonomousadcs_attitudetelemetry_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_autonomousadcs_attitudetelemetry_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_autonomousadcs_attitudetelemetry_new();
        if (*element_res == NULL) return -1;
        rc = pf_autonomousadcs_attitudetelemetry_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_autonomousadcs_getstatus_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_autonomousadcs_getstatus_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_AUTONOMOUSADCS_ATTITUDETELEMETRY_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_1(mal_encoder_t * encoder, pf_autonomousadcs_actuatorstelemetry_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_autonomousadcs_actuatorstelemetry_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_1(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_actuatorstelemetry_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_autonomousadcs_actuatorstelemetry_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_decode_1(void * cursor, mal_decoder_t * decoder, pf_autonomousadcs_actuatorstelemetry_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_autonomousadcs_actuatorstelemetry_new();
        if (*element_res == NULL) return -1;
        rc = pf_autonomousadcs_actuatorstelemetry_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_autonomousadcs_getstatus_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_autonomousadcs_getstatus_request_response_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_AUTONOMOUSADCS_ACTUATORSTELEMETRY_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_getstatus_request_response_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_getstatus_request_response_decode_2(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_getstatus_request_response_decode_3_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_getstatus_request_response_decode_3(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_BOOLEAN_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_getstatus_request_response_decode_4_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_getstatus_request_response_decode_4(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_5_pf_autonomousadcs_attitudemodebdot(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodebdot_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODEBDOT_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodebdot_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_5_pf_autonomousadcs_attitudemodebdot(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodebdot_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODEBDOT_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodebdot_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_5_pf_autonomousadcs_attitudemodenadirpointing(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodenadirpointing_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODENADIRPOINTING_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodenadirpointing_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_5_pf_autonomousadcs_attitudemodenadirpointing(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodenadirpointing_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODENADIRPOINTING_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodenadirpointing_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_5_pf_autonomousadcs_attitudemodesinglespinning(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesinglespinning_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODESINGLESPINNING_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesinglespinning_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_5_pf_autonomousadcs_attitudemodesinglespinning(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesinglespinning_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODESINGLESPINNING_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesinglespinning_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_5_pf_autonomousadcs_attitudemodesunpointing(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesunpointing_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODESUNPOINTING_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesunpointing_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_5_pf_autonomousadcs_attitudemodesunpointing(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodesunpointing_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODESUNPOINTING_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodesunpointing_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_5_pf_autonomousadcs_attitudemodetargettracking(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettracking_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKING_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettracking_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_5_pf_autonomousadcs_attitudemodetargettracking(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettracking_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKING_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettracking_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_5_pf_autonomousadcs_attitudemodetargettrackinglinear(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettrackinglinear_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKINGLINEAR_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettrackinglinear_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_5_pf_autonomousadcs_attitudemodetargettrackinglinear(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodetargettrackinglinear_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODETARGETTRACKINGLINEAR_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodetargettrackinglinear_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_add_encoding_length_5_pf_autonomousadcs_attitudemodevectorpointing(mal_encoder_t * encoder, pf_autonomousadcs_attitudemodevectorpointing_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = mal_encoder_add_short_form_encoding_length(encoder, PF_AUTONOMOUSADCS_ATTITUDEMODEVECTORPOINTING_SHORT_FORM, cursor);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodevectorpointing_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_encode_5_pf_autonomousadcs_attitudemodevectorpointing(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_attitudemodevectorpointing_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_encoder_encode_short_form(encoder, cursor, PF_AUTONOMOUSADCS_ATTITUDEMODEVECTORPOINTING_SHORT_FORM);
        if (rc < 0)
          return rc;
        rc = pf_autonomousadcs_attitudemodevectorpointing_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_getstatus_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2, mal_element_holder_t * arg3, mal_element_holder_t * arg4, mal_element_holder_t * arg5)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_1(encoder,arg1->value.composite_value,cursor);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_2(encoder,true,arg2->value.duration_value,cursor);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_2(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_3(encoder,true,arg3->value.boolean_value,cursor);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_3(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg4
  if (arg4 != NULL && arg4->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_4(encoder,true,arg4->value.duration_value,cursor);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_4(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg5
  rc = pf_autonomousadcs_getstatus_request_response_add_encoding_length_5(encoder,arg5,cursor);
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  mal_encoder_cursor_init(encoder, cursor, mal_message_get_body(message), mal_encoder_cursor_get_length(encoder, cursor), mal_message_get_body_offset(message));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_encode_1(cursor,encoder,arg1->value.composite_value);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_encode_2(cursor,encoder,true,arg2->value.duration_value);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_encode_2(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_encode_3(cursor,encoder,true,arg3->value.boolean_value);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_encode_3(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg4
  if (arg4 != NULL && arg4->presence_flag) {
    rc = pf_autonomousadcs_getstatus_request_response_encode_4(cursor,encoder,true,arg4->value.duration_value);
  } else {
    rc = pf_autonomousadcs_getstatus_request_response_encode_4(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg5
  rc = pf_autonomousadcs_getstatus_request_response_encode_5(cursor,encoder,arg5);
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_getstatus_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETDESIREDATTITUDE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_autonomousadcs_setdesiredattitude_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setdesiredattitude_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setdesiredattitude_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setdesiredattitude_submit_add_encoding_length_0(encoder,true,arg0->value.duration_value,cursor);
  } else {
    rc = pf_autonomousadcs_setdesiredattitude_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  rc = pf_autonomousadcs_setdesiredattitude_submit_add_encoding_length_1(encoder,arg1,cursor);
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  mal_encoder_cursor_init(encoder, cursor, mal_message_get_body(message), mal_encoder_cursor_get_length(encoder, cursor), mal_message_get_body_offset(message));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setdesiredattitude_submit_encode_0(cursor,encoder,true,arg0->value.duration_value);
  } else {
    rc = pf_autonomousadcs_setdesiredattitude_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  rc = pf_autonomousadcs_setdesiredattitude_submit_encode_1(cursor,encoder,arg1);
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setdesiredattitude_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETDESIREDATTITUDE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_setdesiredattitude_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setdesiredattitude_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETREACTIONWHEELSPEED_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        ...
        if (rc < 0)
          return rc;
        *element_res = (pf_autonomousadcs_reactionwheelidentifier_t) enumerated_value;
        (*presence_flag_res) = presence_flag;
      }
      break;
    }
...
int pf_autonomousadcs_setreactionwheelspeed_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setreactionwheelspeed_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_AUTONOMOUSADCS_REACTIONWHEELIDENTIFIER_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_setreactionwheelspeed_submit_decode_1(void * cursor, mal_decoder_t * decoder, bool * presence_flag_res, mal_float_t * element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = mal_decoder_decode_float(decoder, cursor, element_res);
        if (rc < 0)
          return rc;
        (*presence_flag_res) = presence_flag;
      }
...
int pf_autonomousadcs_setreactionwheelspeed_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setreactionwheelspeed_submit_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_setreactionwheelspeed_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_add_encoding_length_0(encoder,true,arg0->value.enumerated_value,cursor);
  } else {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_add_encoding_length_1(encoder,true,arg1->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_encode_0(cursor,encoder,true,arg0->value.enumerated_value);
  } else {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_encode_1(cursor,encoder,true,arg1->value.float_value);
  } else {
    rc = pf_autonomousadcs_setreactionwheelspeed_submit_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setreactionwheelspeed_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETREACTIONWHEELSPEED_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_setreactionwheelspeed_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setreactionwheelspeed_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETALLREACTIONWHEELSPEEDS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_2(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_3_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_3(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_4_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_4(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_5_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_decode_5(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2, mal_element_holder_t * arg3, mal_element_holder_t * arg4, mal_element_holder_t * arg5)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_0(encoder,true,arg0->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_1(encoder,true,arg1->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_2(encoder,true,arg2->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_2(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_3(encoder,true,arg3->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_3(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg4
  if (arg4 != NULL && arg4->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_4(encoder,true,arg4->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_4(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg5
  if (arg5 != NULL && arg5->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_5(encoder,true,arg5->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_add_encoding_length_5(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_0(cursor,encoder,true,arg0->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_1(cursor,encoder,true,arg1->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_2(cursor,encoder,true,arg2->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_2(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg3
  if (arg3 != NULL && arg3->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_3(cursor,encoder,true,arg3->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_3(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg4
  if (arg4 != NULL && arg4->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_4(cursor,encoder,true,arg4->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_4(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg5
  if (arg5 != NULL && arg5->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_5(cursor,encoder,true,arg5->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_encode_5(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETALLREACTIONWHEELSPEEDS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_setallreactionwheelspeeds_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setallreactionwheelspeeds_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETALLREACTIONWHEELPARAMETERS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_autonomousadcs_setallreactionwheelparameters_submit_add_encoding_length_0(mal_encoder_t * encoder, pf_autonomousadcs_reactionwheelparameters_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_autonomousadcs_reactionwheelparameters_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_setallreactionwheelparameters_submit_encode_0(void * cursor, mal_encoder_t * encoder, pf_autonomousadcs_reactionwheelparameters_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_autonomousadcs_reactionwheelparameters_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_autonomousadcs_setallreactionwheelparameters_submit_decode_0(void * cursor, mal_decoder_t * decoder, pf_autonomousadcs_reactionwheelparameters_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_autonomousadcs_reactionwheelparameters_new();
        if (*element_res == NULL) return -1;
        rc = pf_autonomousadcs_reactionwheelparameters_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_autonomousadcs_setallreactionwheelparameters_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_autonomousadcs_setallreactionwheelparameters_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_AUTONOMOUSADCS_REACTIONWHEELPARAMETERS_SHORT_FORM);
  return rc;
}
...
int pf_autonomousadcs_setallreactionwheelparameters_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelparameters_submit_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelparameters_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setallreactionwheelparameters_submit_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_autonomousadcs_setallreactionwheelparameters_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setallreactionwheelparameters_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETALLREACTIONWHEELPARAMETERS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_setallreactionwheelparameters_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setallreactionwheelparameters_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETALLMAGNETORQUERSDIPOLEMOMENTS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_decode_2(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FLOAT_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_add_encoding_length_0(encoder,true,arg0->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_add_encoding_length_1(encoder,true,arg1->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_add_encoding_length_2(encoder,true,arg2->value.float_value,cursor);
  } else {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_add_encoding_length_2(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_encode_0(cursor,encoder,true,arg0->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_encode_1(cursor,encoder,true,arg1->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_encode_2(cursor,encoder,true,arg2->value.float_value);
  } else {
    rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_encode_2(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_SETALLMAGNETORQUERSDIPOLEMOMENTS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_setallmagnetorquersdipolemoments_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_GETALLREACTIONWHEELPARAMETERS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_autonomousadcs_getallreactionwheelparameters_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_getallreactionwheelparameters_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_AUTONOMOUSADCS_SERVICE_NUMBER, PF_AUTONOMOUSADCS_GETALLREACTIONWHEELPARAMETERS_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_autonomousadcs_getallreactionwheelparameters_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_autonomousadcs_getallreactionwheelparameters_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_AUTONOMOUSADCS_REACTIONWHEELPARAMETERS_SHORT_FORM);
  return rc;
...
int pf_autonomousadcs_getallreactionwheelparameters_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_getallreactionwheelparameters_request_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_autonomousadcs_getallreactionwheelparameters_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_autonomousadcs_getallreactionwheelparameters_request_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_autonomousadcs_getallreactionwheelparameters_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_autonomousadcs_getallreactionwheelparameters_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int pf_softwaredefinedradio_streamradio_update_add_encoding_length_0(mal_encoder_t * encoder, pf_softwaredefinedradio_iqcomponents_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      if ((element != NULL))
      {
        rc = pf_softwaredefinedradio_iqcomponents_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_softwaredefinedradio_streamradio_update_encode_0(void * cursor, mal_encoder_t * encoder, pf_softwaredefinedradio_iqcomponents_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_softwaredefinedradio_iqcomponents_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_softwaredefinedradio_streamradio_update_decode_0(void * cursor, mal_decoder_t * decoder, pf_softwaredefinedradio_iqcomponents_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_softwaredefinedradio_iqcomponents_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_softwaredefinedradio_iqcomponents_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_softwaredefinedradio_streamradio_update_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_softwaredefinedradio_streamradio_update_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_SOFTWAREDEFINEDRADIO_IQCOMPONENTS_LIST_SHORT_FORM);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_STREAMRADIO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_REGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
int pf_softwaredefinedradio_streamradio_register_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_softwaredefinedradio_streamradio_register(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_STREAMRADIO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_REGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_STREAMRADIO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH);
  mal_message_set_transaction_id(message, initial_publish_register_tid);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, false);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_STREAMRADIO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
int pf_softwaredefinedradio_streamradio_deregister_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * broker_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_softwaredefinedradio_streamradio_deregister(endpoint, message, broker_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_STREAMRADIO_OPERATION_NUMBER, MAL_INTERACTIONTYPE_PUBSUB, MAL_IP_STAGE_PUBSUB_PUBLISH_DEREGISTER);
  rc = mal_endpoint_init_operation(endpoint, message, broker_uri, true);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_ENABLESDR_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_softwaredefinedradio_enablesdr_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_softwaredefinedradio_enablesdr_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_BOOLEAN_SHORT_FORM);
  return rc;
...
int pf_softwaredefinedradio_enablesdr_submit_add_encoding_length_1(mal_encoder_t * encoder, pf_softwaredefinedradio_sdrconfiguration_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_softwaredefinedradio_sdrconfiguration_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_softwaredefinedradio_enablesdr_submit_encode_1(void * cursor, mal_encoder_t * encoder, pf_softwaredefinedradio_sdrconfiguration_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_softwaredefinedradio_sdrconfiguration_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_softwaredefinedradio_enablesdr_submit_decode_1(void * cursor, mal_decoder_t * decoder, pf_softwaredefinedradio_sdrconfiguration_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_softwaredefinedradio_sdrconfiguration_new();
        if (*element_res == NULL) return -1;
        rc = pf_softwaredefinedradio_sdrconfiguration_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_softwaredefinedradio_enablesdr_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_softwaredefinedradio_enablesdr_submit_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_SOFTWAREDEFINEDRADIO_SDRCONFIGURATION_SHORT_FORM);
  return rc;
}
...
int pf_softwaredefinedradio_enablesdr_submit_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_softwaredefinedradio_enablesdr_submit_decode_2(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_softwaredefinedradio_enablesdr_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_softwaredefinedradio_enablesdr_submit_add_encoding_length_0(encoder,true,arg0->value.boolean_value,cursor);
  } else {
    rc = pf_softwaredefinedradio_enablesdr_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_softwaredefinedradio_enablesdr_submit_add_encoding_length_1(encoder,arg1->value.composite_value,cursor);
  } else {
    rc = pf_softwaredefinedradio_enablesdr_submit_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_softwaredefinedradio_enablesdr_submit_add_encoding_length_2(encoder,true,arg2->value.duration_value,cursor);
  } else {
    rc = pf_softwaredefinedradio_enablesdr_submit_add_encoding_length_2(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_softwaredefinedradio_enablesdr_submit_encode_0(cursor,encoder,true,arg0->value.boolean_value);
  } else {
    rc = pf_softwaredefinedradio_enablesdr_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = pf_softwaredefinedradio_enablesdr_submit_encode_1(cursor,encoder,arg1->value.composite_value);
  } else {
    rc = pf_softwaredefinedradio_enablesdr_submit_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = pf_softwaredefinedradio_enablesdr_submit_encode_2(cursor,encoder,true,arg2->value.duration_value);
  } else {
    rc = pf_softwaredefinedradio_enablesdr_submit_encode_2(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_softwaredefinedradio_enablesdr_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_ENABLESDR_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_softwaredefinedradio_enablesdr_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_softwaredefinedradio_enablesdr_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_UPDATECONFIGURATION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_softwaredefinedradio_updateconfiguration_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_softwaredefinedradio_updateconfiguration_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_SOFTWAREDEFINEDRADIO_SDRCONFIGURATION_SHORT_FORM);
  return rc;
...
int pf_softwaredefinedradio_updateconfiguration_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_softwaredefinedradio_updateconfiguration_submit_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = pf_softwaredefinedradio_updateconfiguration_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_softwaredefinedradio_updateconfiguration_submit_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = pf_softwaredefinedradio_updateconfiguration_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_softwaredefinedradio_updateconfiguration_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_SOFTWAREDEFINEDRADIO_SERVICE_NUMBER, PF_SOFTWAREDEFINEDRADIO_UPDATECONFIGURATION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_softwaredefinedradio_updateconfiguration_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_softwaredefinedradio_updateconfiguration_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_OPTICALDATARECEIVER_SERVICE_NUMBER, PF_OPTICALDATARECEIVER_RECORDSAMPLES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_opticaldatareceiver_recordsamples_invoke_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = pf_opticaldatareceiver_recordsamples_invoke_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_DURATION_SHORT_FORM);
  return rc;
...
int pf_opticaldatareceiver_recordsamples_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_opticaldatareceiver_recordsamples_invoke_add_encoding_length_0(encoder,true,arg0->value.duration_value,cursor);
  } else {
    rc = pf_opticaldatareceiver_recordsamples_invoke_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_opticaldatareceiver_recordsamples_invoke_encode_0(cursor,encoder,true,arg0->value.duration_value);
  } else {
    rc = pf_opticaldatareceiver_recordsamples_invoke_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_opticaldatareceiver_recordsamples_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_OPTICALDATARECEIVER_SERVICE_NUMBER, PF_OPTICALDATARECEIVER_RECORDSAMPLES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_opticaldatareceiver_recordsamples_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_opticaldatareceiver_recordsamples_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_OPTICALDATARECEIVER_SERVICE_NUMBER, PF_OPTICALDATARECEIVER_RECORDSAMPLES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_opticaldatareceiver_recordsamples_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_opticaldatareceiver_recordsamples_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int pf_opticaldatareceiver_recordsamples_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_opticaldatareceiver_recordsamples_invoke_response_add_encoding_length_0(encoder,arg0->value.blob_value,cursor);
  } else {
    rc = pf_opticaldatareceiver_recordsamples_invoke_response_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_opticaldatareceiver_recordsamples_invoke_response_encode_0(cursor,encoder,arg0->value.blob_value);
  } else {
    rc = pf_opticaldatareceiver_recordsamples_invoke_response_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_opticaldatareceiver_recordsamples_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int PF_POWERCONTROL_DEVICETYPE_NUMERIC_VALUES[] =
{
  1,
  2,
  3,
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_POWERCONTROL_SERVICE_NUMBER, PF_POWERCONTROL_LISTDEVICES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_powercontrol_listdevices_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_powercontrol_listdevices_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_IDENTIFIER_LIST_SHORT_FORM);
  return rc;
...
int pf_powercontrol_listdevices_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_powercontrol_listdevices_request_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_powercontrol_listdevices_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_powercontrol_listdevices_request_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_powercontrol_listdevices_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_powercontrol_listdevices_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_POWERCONTROL_SERVICE_NUMBER, PF_POWERCONTROL_LISTDEVICES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_powercontrol_listdevices_request_response_add_encoding_length_0(mal_encoder_t * encoder, pf_powercontrol_device_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = pf_powercontrol_device_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_powercontrol_listdevices_request_response_encode_0(void * cursor, mal_encoder_t * encoder, pf_powercontrol_device_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = pf_powercontrol_device_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int pf_powercontrol_listdevices_request_response_decode_0(void * cursor, mal_decoder_t * decoder, pf_powercontrol_device_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = pf_powercontrol_device_list_new(0);
        if (*element_res == NULL) return -1;
        rc = pf_powercontrol_device_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int pf_powercontrol_listdevices_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_powercontrol_listdevices_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_POWERCONTROL_DEVICE_LIST_SHORT_FORM);
  return rc;
}
...
int pf_powercontrol_listdevices_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_powercontrol_listdevices_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_powercontrol_listdevices_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_powercontrol_listdevices_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_powercontrol_listdevices_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_powercontrol_listdevices_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_POWERCONTROL_SERVICE_NUMBER, PF_POWERCONTROL_ENABLEDEVICES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int pf_powercontrol_enabledevices_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = pf_powercontrol_enabledevices_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, PF_POWERCONTROL_DEVICE_LIST_SHORT_FORM);
  return rc;
...
int pf_powercontrol_enabledevices_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_powercontrol_enabledevices_request_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = pf_powercontrol_enabledevices_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = pf_powercontrol_enabledevices_request_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = pf_powercontrol_enabledevices_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_powercontrol_enabledevices_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, PF_AREA_NUMBER, PF_AREA_VERSION, PF_POWERCONTROL_SERVICE_NUMBER, PF_POWERCONTROL_ENABLEDEVICES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int pf_powercontrol_enabledevices_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = pf_powercontrol_enabledevices_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
