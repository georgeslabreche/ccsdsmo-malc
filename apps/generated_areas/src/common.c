...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_LOOKUPPROVIDER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
...
int common_directory_lookupprovider_request_add_encoding_length_0(mal_encoder_t * encoder, common_directory_servicefilter_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = common_directory_servicefilter_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_directory_lookupprovider_request_encode_0(void * cursor, mal_encoder_t * encoder, common_directory_servicefilter_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = common_directory_servicefilter_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_directory_lookupprovider_request_decode_0(void * cursor, mal_decoder_t * decoder, common_directory_servicefilter_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = common_directory_servicefilter_new();
        if (*element_res == NULL) return -1;
        rc = common_directory_servicefilter_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_directory_lookupprovider_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  rc = common_directory_lookupprovider_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  ...
  mal_element_holder_set_short_form(element_holder, COMMON_DIRECTORY_SERVICEFILTER_SHORT_FORM);
  return rc;
}
...
int common_directory_lookupprovider_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_lookupprovider_request_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_directory_lookupprovider_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_lookupprovider_request_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_directory_lookupprovider_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  ...
  rc = common_directory_lookupprovider_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_LOOKUPPROVIDER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
...
int common_directory_lookupprovider_request_response_add_encoding_length_0(mal_encoder_t * encoder, common_directory_providersummary_list_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = common_directory_providersummary_list_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_directory_lookupprovider_request_response_encode_0(void * cursor, mal_encoder_t * encoder, common_directory_providersummary_list_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = common_directory_providersummary_list_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_directory_lookupprovider_request_response_decode_0(void * cursor, mal_decoder_t * decoder, common_directory_providersummary_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = common_directory_providersummary_list_new(0);
        if (*element_res == NULL) return -1;
        rc = common_directory_providersummary_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_directory_lookupprovider_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_directory_lookupprovider_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_DIRECTORY_PROVIDERSUMMARY_LIST_SHORT_FORM);
  return rc;
}
...
int common_directory_lookupprovider_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_lookupprovider_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = common_directory_lookupprovider_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_lookupprovider_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = common_directory_lookupprovider_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_directory_lookupprovider_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int common_directory_lookupprovider_error_decode(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = common_malbinary_decode_mal_element(decoder, cursor, element_holder);
        if (rc < 0)
          return rc;
      }
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_PUBLISHPROVIDER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_directory_publishprovider_request_add_encoding_length_0(mal_encoder_t * encoder, common_directory_publishdetails_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = common_directory_publishdetails_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_directory_publishprovider_request_encode_0(void * cursor, mal_encoder_t * encoder, common_directory_publishdetails_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = common_directory_publishdetails_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_directory_publishprovider_request_decode_0(void * cursor, mal_decoder_t * decoder, common_directory_publishdetails_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = common_directory_publishdetails_new();
        if (*element_res == NULL) return -1;
        rc = common_directory_publishdetails_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_directory_publishprovider_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_directory_publishprovider_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_DIRECTORY_PUBLISHDETAILS_SHORT_FORM);
  return rc;
}
...
int common_directory_publishprovider_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_publishprovider_request_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_directory_publishprovider_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_publishprovider_request_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_directory_publishprovider_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_directory_publishprovider_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_PUBLISHPROVIDER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_directory_publishprovider_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_directory_publishprovider_request_response_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
...
int common_directory_publishprovider_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_directory_publishprovider_request_response_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_SHORT_FORM);
  return rc;
...
int common_directory_publishprovider_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_publishprovider_request_response_add_encoding_length_0(encoder,true,arg0->value.long_value,cursor);
  } else {
    rc = common_directory_publishprovider_request_response_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_directory_publishprovider_request_response_add_encoding_length_1(encoder,true,arg1->value.long_value,cursor);
  } else {
    rc = common_directory_publishprovider_request_response_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_publishprovider_request_response_encode_0(cursor,encoder,true,arg0->value.long_value);
  } else {
    rc = common_directory_publishprovider_request_response_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_directory_publishprovider_request_response_encode_1(cursor,encoder,true,arg1->value.long_value);
  } else {
    rc = common_directory_publishprovider_request_response_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_directory_publishprovider_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_WITHDRAWPROVIDER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_directory_withdrawprovider_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_directory_withdrawprovider_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_SHORT_FORM);
  return rc;
...
int common_directory_withdrawprovider_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_withdrawprovider_submit_add_encoding_length_0(encoder,true,arg0->value.long_value,cursor);
  } else {
    rc = common_directory_withdrawprovider_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_withdrawprovider_submit_encode_0(cursor,encoder,true,arg0->value.long_value);
  } else {
    rc = common_directory_withdrawprovider_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_directory_withdrawprovider_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_WITHDRAWPROVIDER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_directory_withdrawprovider_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_directory_withdrawprovider_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_GETSERVICEXML_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_directory_getservicexml_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_directory_getservicexml_request_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_SHORT_FORM);
  return rc;
...
int common_directory_getservicexml_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_getservicexml_request_add_encoding_length_0(encoder,true,arg0->value.long_value,cursor);
  } else {
    rc = common_directory_getservicexml_request_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_getservicexml_request_encode_0(cursor,encoder,true,arg0->value.long_value);
  } else {
    rc = common_directory_getservicexml_request_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_directory_getservicexml_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_DIRECTORY_SERVICE_NUMBER, COMMON_DIRECTORY_GETSERVICEXML_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_directory_getservicexml_request_response_decode_0(void * cursor, mal_decoder_t * decoder, mal_file_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = mal_file_list_new(0);
        if (*element_res == NULL) return -1;
        rc = mal_file_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_directory_getservicexml_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_directory_getservicexml_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FILE_LIST_SHORT_FORM);
  return rc;
}
...
int common_directory_getservicexml_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_getservicexml_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = common_directory_getservicexml_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_directory_getservicexml_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = common_directory_getservicexml_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_directory_getservicexml_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_LOGIN_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_login_login_request_add_encoding_length_0(mal_encoder_t * encoder, common_login_profile_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = common_login_profile_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_login_login_request_encode_0(void * cursor, mal_encoder_t * encoder, common_login_profile_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = common_login_profile_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_login_login_request_decode_0(void * cursor, mal_decoder_t * decoder, common_login_profile_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = common_login_profile_new();
        if (*element_res == NULL) return -1;
        rc = common_login_profile_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_login_login_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_login_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_LOGIN_PROFILE_SHORT_FORM);
  return rc;
}
...
int common_login_login_request_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_login_request_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int common_login_login_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_login_request_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_login_login_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_login_request_add_encoding_length_1(encoder,arg1->value.string_value,cursor);
  } else {
    rc = common_login_login_request_add_encoding_length_1(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_login_request_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_login_login_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_login_request_encode_1(cursor,encoder,arg1->value.string_value);
  } else {
    rc = common_login_login_request_encode_1(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_login_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_LOGIN_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_login_login_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_login_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int common_login_login_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_login_login_request_response_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_SHORT_FORM);
  return rc;
...
int common_login_login_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_login_request_response_add_encoding_length_0(encoder,arg0->value.blob_value,cursor);
  } else {
    rc = common_login_login_request_response_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_login_request_response_add_encoding_length_1(encoder,true,arg1->value.long_value,cursor);
  } else {
    rc = common_login_login_request_response_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_login_request_response_encode_0(cursor,encoder,arg0->value.blob_value);
  } else {
    rc = common_login_login_request_response_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_login_request_response_encode_1(cursor,encoder,true,arg1->value.long_value);
  } else {
    rc = common_login_login_request_response_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_login_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_LOGOUT_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_login_logout_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_logout_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_LOGOUT_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_login_logout_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_logout_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_LISTROLES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_login_listroles_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_listroles_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int common_login_listroles_request_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_listroles_request_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_STRING_SHORT_FORM);
  return rc;
...
int common_login_listroles_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_listroles_request_add_encoding_length_0(encoder,arg0->value.identifier_value,cursor);
  } else {
    rc = common_login_listroles_request_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_listroles_request_add_encoding_length_1(encoder,arg1->value.string_value,cursor);
  } else {
    rc = common_login_listroles_request_add_encoding_length_1(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_listroles_request_encode_0(cursor,encoder,arg0->value.identifier_value);
  } else {
    rc = common_login_listroles_request_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_listroles_request_encode_1(cursor,encoder,arg1->value.string_value);
  } else {
    rc = common_login_listroles_request_encode_1(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_listroles_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_LISTROLES_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_login_listroles_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_listroles_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int common_login_listroles_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_listroles_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = common_login_listroles_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_listroles_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = common_login_listroles_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_listroles_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_HANDOVER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_login_handover_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_handover_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_LOGIN_PROFILE_SHORT_FORM);
  return rc;
...
int common_login_handover_request_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_handover_request_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_STRING_SHORT_FORM);
  return rc;
...
int common_login_handover_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_handover_request_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_login_handover_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_handover_request_add_encoding_length_1(encoder,arg1->value.string_value,cursor);
  } else {
    rc = common_login_handover_request_add_encoding_length_1(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_handover_request_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_login_handover_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_handover_request_encode_1(cursor,encoder,arg1->value.string_value);
  } else {
    rc = common_login_handover_request_encode_1(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_handover_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_LOGIN_SERVICE_NUMBER, COMMON_LOGIN_HANDOVER_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_login_handover_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_login_handover_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_BLOB_SHORT_FORM);
  return rc;
...
int common_login_handover_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_login_handover_request_response_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_SHORT_FORM);
  return rc;
...
int common_login_handover_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_handover_request_response_add_encoding_length_0(encoder,arg0->value.blob_value,cursor);
  } else {
    rc = common_login_handover_request_response_add_encoding_length_0(encoder,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_handover_request_response_add_encoding_length_1(encoder,true,arg1->value.long_value,cursor);
  } else {
    rc = common_login_handover_request_response_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_login_handover_request_response_encode_0(cursor,encoder,arg0->value.blob_value);
  } else {
    rc = common_login_handover_request_response_encode_0(cursor,encoder,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_login_handover_request_response_encode_1(cursor,encoder,true,arg1->value.long_value);
  } else {
    rc = common_login_handover_request_response_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_login_handover_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int COMMON_CONFIGURATION_CONFIGURATIONTYPE_NUMERIC_VALUES[] =
{
  1,
  2
};
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_ACTIVATE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_configuration_activate_invoke_decode_0(void * cursor, mal_decoder_t * decoder, com_objectkey_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = com_objectkey_new();
        if (*element_res == NULL) return -1;
        rc = com_objectkey_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_configuration_activate_invoke_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_activate_invoke_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTKEY_SHORT_FORM);
  return rc;
}
...
int common_configuration_activate_invoke_decode_1(void * cursor, mal_decoder_t * decoder, com_objectid_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = com_objectid_new();
        if (*element_res == NULL) return -1;
        rc = com_objectid_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_configuration_activate_invoke_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_activate_invoke_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_SHORT_FORM);
  return rc;
}
...
int common_configuration_activate_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_activate_invoke_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_activate_invoke_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_activate_invoke_add_encoding_length_1(encoder,arg1->value.composite_value,cursor);
  } else {
    rc = common_configuration_activate_invoke_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_activate_invoke_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_activate_invoke_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_activate_invoke_encode_1(cursor,encoder,arg1->value.composite_value);
  } else {
    rc = common_configuration_activate_invoke_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_activate_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_ACTIVATE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_activate_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_activate_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_ACTIVATE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_activate_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_configuration_activate_invoke_response_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
...
int common_configuration_activate_invoke_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_activate_invoke_response_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int common_configuration_activate_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_activate_invoke_response_add_encoding_length_0(encoder,true,arg0->value.boolean_value,cursor);
  } else {
    rc = common_configuration_activate_invoke_response_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_activate_invoke_response_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = common_configuration_activate_invoke_response_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_activate_invoke_response_encode_0(cursor,encoder,true,arg0->value.boolean_value);
  } else {
    rc = common_configuration_activate_invoke_response_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_activate_invoke_response_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = common_configuration_activate_invoke_response_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_activate_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_LIST_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        ...
        if (rc < 0)
          return rc;
        *element_res = (common_configuration_configurationtype_t) enumerated_value;
        (*presence_flag_res) = presence_flag;
      }
      break;
    }
...
int common_configuration_list_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_configuration_list_request_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_CONFIGURATION_CONFIGURATIONTYPE_SHORT_FORM);
  return rc;
}
...
int common_configuration_list_request_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_list_request_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int common_configuration_list_request_add_encoding_length_2(mal_encoder_t * encoder, common_servicekey_t * element, void * cursor)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if ((element != NULL))
      {
        rc = common_servicekey_add_encoding_length_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_configuration_list_request_encode_2(void * cursor, mal_encoder_t * encoder, common_servicekey_t * element)
{
  ...
  switch (encoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        rc = common_servicekey_encode_malbinary(element, encoder, cursor);
        if (rc < 0)
          return rc;
      }
      break;
...
int common_configuration_list_request_decode_2(void * cursor, mal_decoder_t * decoder, common_servicekey_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = common_servicekey_new();
        if (*element_res == NULL) return -1;
        rc = common_servicekey_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_configuration_list_request_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_list_request_decode_2(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_SERVICEKEY_SHORT_FORM);
  return rc;
}
...
int common_configuration_list_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_list_request_add_encoding_length_0(encoder,true,arg0->value.enumerated_value,cursor);
  } else {
    rc = common_configuration_list_request_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_list_request_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = common_configuration_list_request_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = common_configuration_list_request_add_encoding_length_2(encoder,arg2->value.composite_value,cursor);
  } else {
    rc = common_configuration_list_request_add_encoding_length_2(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_list_request_encode_0(cursor,encoder,true,arg0->value.enumerated_value);
  } else {
    rc = common_configuration_list_request_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_list_request_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = common_configuration_list_request_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = common_configuration_list_request_encode_2(cursor,encoder,arg2->value.composite_value);
  } else {
    rc = common_configuration_list_request_encode_2(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_list_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_LIST_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_list_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_list_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_LIST_SHORT_FORM);
  return rc;
...
int common_configuration_list_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_list_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = common_configuration_list_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_list_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = common_configuration_list_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_list_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_GETCURRENT_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_configuration_getcurrent_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_getcurrent_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTKEY_SHORT_FORM);
  return rc;
...
int common_configuration_getcurrent_request_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_getcurrent_request_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_SERVICEKEY_SHORT_FORM);
  return rc;
...
int common_configuration_getcurrent_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_getcurrent_request_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_getcurrent_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_getcurrent_request_add_encoding_length_1(encoder,arg1->value.composite_value,cursor);
  } else {
    rc = common_configuration_getcurrent_request_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_getcurrent_request_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_getcurrent_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_getcurrent_request_encode_1(cursor,encoder,arg1->value.composite_value);
  } else {
    rc = common_configuration_getcurrent_request_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_getcurrent_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_GETCURRENT_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_getcurrent_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_getcurrent_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_LIST_SHORT_FORM);
  return rc;
...
int common_configuration_getcurrent_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_getcurrent_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = common_configuration_getcurrent_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_getcurrent_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = common_configuration_getcurrent_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_getcurrent_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_EXPORTXML_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_configuration_exportxml_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_exportxml_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_SHORT_FORM);
  return rc;
...
int common_configuration_exportxml_request_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_configuration_exportxml_request_decode_1(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_BOOLEAN_SHORT_FORM);
  return rc;
...
int common_configuration_exportxml_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_exportxml_request_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_exportxml_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_exportxml_request_add_encoding_length_1(encoder,true,arg1->value.boolean_value,cursor);
  } else {
    rc = common_configuration_exportxml_request_add_encoding_length_1(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_exportxml_request_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_exportxml_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_exportxml_request_encode_1(cursor,encoder,true,arg1->value.boolean_value);
  } else {
    rc = common_configuration_exportxml_request_encode_1(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_exportxml_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_EXPORTXML_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_exportxml_request_response_decode_0(void * cursor, mal_decoder_t * decoder, mal_file_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = mal_file_new();
        if (*element_res == NULL) return -1;
        rc = mal_file_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int common_configuration_exportxml_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_exportxml_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FILE_SHORT_FORM);
  return rc;
}
...
int common_configuration_exportxml_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_exportxml_request_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_exportxml_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_exportxml_request_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_exportxml_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_exportxml_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_ADD_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_configuration_add_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_add_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTKEY_SHORT_FORM);
  return rc;
...
int common_configuration_add_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_add_submit_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_LIST_SHORT_FORM);
  return rc;
...
int common_configuration_add_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_add_submit_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_add_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_add_submit_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = common_configuration_add_submit_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_add_submit_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_add_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_add_submit_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = common_configuration_add_submit_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_add_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_ADD_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_add_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_add_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_REMOVE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_configuration_remove_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_remove_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTKEY_SHORT_FORM);
  return rc;
...
int common_configuration_remove_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_remove_submit_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_LIST_SHORT_FORM);
  return rc;
...
int common_configuration_remove_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_remove_submit_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_remove_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_remove_submit_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = common_configuration_remove_submit_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_remove_submit_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_remove_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_remove_submit_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = common_configuration_remove_submit_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_remove_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_REMOVE_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_remove_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_remove_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_STORECURRENT_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_configuration_storecurrent_invoke_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_storecurrent_invoke_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTKEY_SHORT_FORM);
  return rc;
...
int common_configuration_storecurrent_invoke_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_storecurrent_invoke_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COMMON_SERVICEKEY_SHORT_FORM);
  return rc;
...
int common_configuration_storecurrent_invoke_decode_2_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = common_configuration_storecurrent_invoke_decode_2(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_BOOLEAN_SHORT_FORM);
  return rc;
...
int common_configuration_storecurrent_invoke_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1, mal_element_holder_t * arg2)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_storecurrent_invoke_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_storecurrent_invoke_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_storecurrent_invoke_add_encoding_length_1(encoder,arg1->value.composite_value,cursor);
  } else {
    rc = common_configuration_storecurrent_invoke_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = common_configuration_storecurrent_invoke_add_encoding_length_2(encoder,true,arg2->value.boolean_value,cursor);
  } else {
    rc = common_configuration_storecurrent_invoke_add_encoding_length_2(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_storecurrent_invoke_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_storecurrent_invoke_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = common_configuration_storecurrent_invoke_encode_1(cursor,encoder,arg1->value.composite_value);
  } else {
    rc = common_configuration_storecurrent_invoke_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg2
  if (arg2 != NULL && arg2->presence_flag) {
    rc = common_configuration_storecurrent_invoke_encode_2(cursor,encoder,true,arg2->value.boolean_value);
  } else {
    rc = common_configuration_storecurrent_invoke_encode_2(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_storecurrent_invoke(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_STORECURRENT_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_storecurrent_invoke_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_storecurrent_invoke_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_STORECURRENT_OPERATION_NUMBER, MAL_INTERACTIONTYPE_INVOKE, MAL_IP_STAGE_INVOKE_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_storecurrent_invoke_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_storecurrent_invoke_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_SHORT_FORM);
  return rc;
...
int common_configuration_storecurrent_invoke_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_storecurrent_invoke_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_storecurrent_invoke_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_storecurrent_invoke_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_storecurrent_invoke_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_storecurrent_invoke_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_IMPORTXML_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int common_configuration_importxml_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_importxml_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_FILE_SHORT_FORM);
  return rc;
...
int common_configuration_importxml_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_importxml_request_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_importxml_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_importxml_request_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_importxml_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_importxml_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, COMMON_AREA_NUMBER, COMMON_AREA_VERSION, COMMON_CONFIGURATION_SERVICE_NUMBER, COMMON_CONFIGURATION_IMPORTXML_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int common_configuration_importxml_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = common_configuration_importxml_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_OBJECTID_SHORT_FORM);
  return rc;
...
int common_configuration_importxml_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_importxml_request_response_add_encoding_length_0(encoder,arg0->value.composite_value,cursor);
  } else {
    rc = common_configuration_importxml_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = common_configuration_importxml_request_response_encode_0(cursor,encoder,arg0->value.composite_value);
  } else {
    rc = common_configuration_importxml_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = common_configuration_importxml_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
