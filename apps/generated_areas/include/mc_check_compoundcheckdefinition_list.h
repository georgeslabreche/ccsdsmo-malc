#ifndef __MC_CHECK_COMPOUNDCHECKDEFINITION_LIST_H_INCLUDED__
#define __MC_CHECK_COMPOUNDCHECKDEFINITION_LIST_H_INCLUDED__
...
#endif // __MC_CHECK_COMPOUNDCHECKDEFINITION_LIST_H_INCLUDED__
