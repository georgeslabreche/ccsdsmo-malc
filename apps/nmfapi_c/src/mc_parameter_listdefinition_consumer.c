...
//  The class logger
clog_logger_t mc_parameter_listdefinition_consumer_logger = CLOG_ERROR_LEVEL;
...
mc_parameter_listdefinition_consumer_new (mal_ctx_t *mal_ctx, mal_uri_t *provider_uri)
{
    ...
    self->consumer_uri = mal_ctx_create_uri(mal_ctx, MC_PARAMETER_LISTDEFINITION_CONSUMER_URI);
...
mc_parameter_listdefinition_consumer_initialize (void *self, mal_actor_t *mal_actor)
{
    ...
    clog_debug(mc_parameter_listdefinition_consumer_logger,
        "mc_parameter_listdefinition_consumer_initialize: send listDefinition request message\n");
