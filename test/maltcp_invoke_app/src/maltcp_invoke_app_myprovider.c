...
// state
struct _maltcp_invoke_app_myprovider_t {
  int encoding_format_code;
  void *encoder;
  void *decoder;
};

maltcp_invoke_app_myprovider_t *maltcp_invoke_app_myprovider_new(int encoding_format_code,
    void *encoder, void *decoder) {
  maltcp_invoke_app_myprovider_t *self = (maltcp_invoke_app_myprovider_t *) malloc(
      sizeof(maltcp_invoke_app_myprovider_t));
  if (!self)
    return NULL;
...
int maltcp_invoke_app_myprovider_get_encoding_format_code(
    maltcp_invoke_app_myprovider_t *self) {
  return self->encoding_format_code;
}

void maltcp_invoke_app_myprovider_set_decoder(maltcp_invoke_app_myprovider_t *self,
    void *decoder) {
  self->decoder = decoder;
}

void *maltcp_invoke_app_myprovider_get_decoder(maltcp_invoke_app_myprovider_t *self) {
  return self->decoder;
}

void *maltcp_invoke_app_myprovider_get_encoder(maltcp_invoke_app_myprovider_t *self) {
  return self->encoder;
}

int maltcp_invoke_app_myprovider_initialize(void *self, mal_actor_t *mal_actor) {
  int rc = 0;
  //maltcp_invoke_app_myprovider_t *provider = (maltcp_invoke_app_myprovider_t *) self;
  printf("### maltcp_invoke_app_myprovider_initialize:\n");
  ...
  rc = mal_routing_register_provider_invoke_handler(
      ...
      maltcp_invoke_app_myprovider_testarea_testservice_testinvoke);

  return rc;
}

int maltcp_invoke_app_myprovider_finalize(void *self, mal_actor_t *mal_actor) {
  int rc = 0;
  //maltcp_invoke_app_myprovider_t *provider = (maltcp_invoke_app_myprovider_t *) self;
  printf("### maltcp_invoke_app_myprovider_finalize:\n");

  return rc;
}

int maltcp_invoke_app_myprovider_testarea_testservice_testinvoke(
    void *self, mal_ctx_t *mal_ctx,
    mal_endpoint_t *mal_endpoint, mal_message_t *message) {
  int rc = 0;

  printf("### maltcp_invoke_app_myconsumer, testinvoke: URI To=%s\n", mal_message_get_uri_to(message));
  ...
  printf("AF: maltcp_invoke_app_myprovider: handler send ACK\n");
  rc = testarea_testservice_testinvoke_invoke_ack(mal_endpoint, message, ack_message, (0 != 0));
  printf("AF: maltcp_invoke_app_myprovider: handler ACK sent\n");
...
//  printf("After sleep\n");
  ...
  printf("maltcp_invoke_app_myprovider: new string list\n");
  ...
  printf("maltcp_invoke_app_myprovider: encoding_length_0\n");
  rc = testarea_testservice_testinvoke_invoke_response_add_encoding_length_0(
		  maltcp_invoke_app_myprovider_get_encoding_format_code(provider),
		  maltcp_invoke_app_myprovider_get_encoder(provider), string_list, &body_length);
  if (rc < 0)
    return rc;
  ...
  printf("maltcp_invoke_app_myprovider: encode 0\n");
  rc = testarea_testservice_testinvoke_invoke_response_encode_0(
		  maltcp_invoke_app_myprovider_get_encoding_format_code(provider), bytes_r, &offset_r,
		  maltcp_invoke_app_myprovider_get_encoder(provider), string_list);
  if (rc < 0)
    return rc;


  printf("AF: maltcp_invoke_app_myprovider: handler send RESPONSE\n");
  rc = testarea_testservice_testinvoke_invoke_response(mal_endpoint, message, result_message, (0 != 0));
  printf("AF: maltcp_invoke_app_myprovider: handler RESPONSE sent\n");
...
void maltcp_invoke_app_myprovider_test(bool verbose) {
  printf(" * maltcp_invoke_app_myprovider_test: ");
  if (verbose)
    printf("\n");
