...
int testarea_testservice_testfinalcompositeb_list_add_encoding_length_malbinary(testarea_testservice_testfinalcompositeb_list_t * self, mal_encoder_t * encoder, void * cursor)
{
  int rc = 0;
  ...
  {
    testarea_testservice_testfinalcompositeb_t * list_element = self->content[i];
    ...
    if (presence_flag)
    {
      rc = testarea_testservice_testfinalcompositeb_add_encoding_length_malbinary(list_element, encoder, cursor);
      if (rc < 0)
        return rc;
    }
  }
...
int testarea_testservice_testfinalcompositeb_list_encode_malbinary(testarea_testservice_testfinalcompositeb_list_t * self, mal_encoder_t * encoder, void * cursor)
{
  int rc = 0;
  unsigned int list_size = self->element_count;
  ...
  for (int i = 0; i < list_size; i++)
  {
    ...
    if (presence_flag)
    {
      rc = testarea_testservice_testfinalcompositeb_encode_malbinary(list_element, encoder, cursor);
      if (rc < 0)
        return rc;
    }
  }
...
int testarea_testservice_testfinalcompositeb_list_decode_malbinary(testarea_testservice_testfinalcompositeb_list_t * self, mal_decoder_t * decoder, void * cursor)
{
  int rc = 0;
  ...
  self->content = (testarea_testservice_testfinalcompositeb_t **) calloc(list_size, sizeof(testarea_testservice_testfinalcompositeb_t *));
  ...
  for (int i = 0; i < list_size; i++)
  {
    ...
    if (presence_flag)
    {
      ...
      rc = testarea_testservice_testfinalcompositeb_decode_malbinary(self->content[i], decoder, cursor);
      if (rc < 0)
        return rc;
    }
  }
