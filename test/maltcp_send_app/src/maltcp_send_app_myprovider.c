...
// state
struct _maltcp_send_app_myprovider_t {
...
maltcp_send_app_myprovider_t *maltcp_send_app_myprovider_new(int encoding_format_code,
  ...
  maltcp_send_app_myprovider_t *self = (maltcp_send_app_myprovider_t *) malloc(
      sizeof(maltcp_send_app_myprovider_t));
  if (!self)
    return NULL;
...
void *maltcp_send_app_myprovider_get_decoder(maltcp_send_app_myprovider_t *self) {
  return self->decoder;
}

int maltcp_send_app_myprovider_initialize(void *self, mal_actor_t *mal_actor) {
  int rc = 0;
  //maltcp_send_app_myprovider_t *provider = (maltcp_send_app_myprovider_t *) self;
  ...
  rc = mal_routing_register_provider_send_handler(
      ...
      maltcp_send_app_myprovider_testarea_testservice_testsend);
...
int maltcp_send_app_myprovider_testarea_testservice_testsend(
  ...
  printf("maltcp_send_app_myprovider_testarea_testservice_testsend: URI To=%s\n",
  ...
  printf("maltcp_send_app_myprovider: offset=%d\n", offset);

  testarea_testservice_testcomposite_t *parameter_0;
  printf("maltcp_send_app_myprovider: decode first parameter\n");
  ...
  printf("maltcp_send_app_myprovider: decode second parameter\n");
  ...
  long short_form;
  void *parameter_2;
  printf("maltcp_send_app_myprovider: decode third parameter\n");
  ...
  printf("maltcp_send_app_myprovider: offset=%d\n", offset);
  printf("maltcp_send_app_myprovider: decoding done, short form=%lu\n",
      short_form);
...
void maltcp_send_app_myprovider_test(bool verbose) {
  printf(" * maltcp_send_app_myprovider_test: ");
  if (verbose)
    printf("\n");
