...
mal_identifier_t *progress_app_myconsumer_get_network_zone(
    progress_app_myconsumer_t *self) {
...
mal_sessiontype_t progress_app_myconsumer_get_session(
    progress_app_myconsumer_t *self) {
  return self->session;
}

mal_identifier_t *progress_app_myconsumer_get_session_name(
    progress_app_myconsumer_t *self) {
