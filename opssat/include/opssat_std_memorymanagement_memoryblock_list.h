#ifndef __OPSSAT_STD_MEMORYMANAGEMENT_MEMORYBLOCK_LIST_H_INCLUDED__
#define __OPSSAT_STD_MEMORYMANAGEMENT_MEMORYBLOCK_LIST_H_INCLUDED__
...
#endif // __OPSSAT_STD_MEMORYMANAGEMENT_MEMORYBLOCK_LIST_H_INCLUDED__
