...
// structure definition for composite mc_parameter_parameterdefinition
struct _mc_parameter_parameterdefinition_t {
...
{
  mc_parameter_parameterdefinition_t *self = (mc_parameter_parameterdefinition_t *) calloc(1, sizeof(mc_parameter_parameterdefinition_t));
  if (!self)
    return NULL;
  return self;
}
...
{
  printf(" * MC:Parameter:ParameterDefinition: ");
  if (verbose)
    printf("\n");
  printf("OK\n");
}
