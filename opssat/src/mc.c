...
int MC_PARAMETER_VALIDITY_NUMERIC_VALUES[] =
{
  1,
  2,
  3,
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_ALERT_SERVICE_NUMBER, MC_ALERT_ENABLEGENERATION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_alert_enablegeneration_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = mc_alert_enablegeneration_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
...
int mc_alert_enablegeneration_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_alert_enablegeneration_submit_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
...
int mc_alert_enablegeneration_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_alert_enablegeneration_submit_add_encoding_length_0(encoder,true,arg0->value.boolean_value,cursor);
  } else {
    rc = mc_alert_enablegeneration_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_alert_enablegeneration_submit_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = mc_alert_enablegeneration_submit_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_alert_enablegeneration_submit_encode_0(cursor,encoder,true,arg0->value.boolean_value);
  } else {
    rc = mc_alert_enablegeneration_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_alert_enablegeneration_submit_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = mc_alert_enablegeneration_submit_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_alert_enablegeneration_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_ALERT_SERVICE_NUMBER, MC_ALERT_ENABLEGENERATION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_alert_enablegeneration_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_alert_enablegeneration_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int mc_check_getsummaryreport_progress_update_decode_1(void * cursor, mal_decoder_t * decoder, mc_check_checksummary_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = mc_check_checksummary_list_new(0);
        if (*element_res == NULL) return -1;
        rc = mc_check_checksummary_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int mc_check_getsummaryreport_progress_update_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MC_CHECK_CHECKSUMMARY_LIST_SHORT_FORM);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_CHECK_SERVICE_NUMBER, MC_CHECK_ADDDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_check_adddefinition_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length
  // Length of arg0
  rc = mc_check_adddefinition_request_add_encoding_length_0(encoder,arg0,cursor);
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  mal_encoder_cursor_init(encoder, cursor, mal_message_get_body(message), mal_encoder_cursor_get_length(encoder, cursor), mal_message_get_body_offset(message));
  // Encoding
  // Encoding arg0
  rc = mc_check_adddefinition_request_encode_0(cursor,encoder,arg0);
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_check_adddefinition_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_CHECK_SERVICE_NUMBER, MC_CHECK_ADDDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_check_adddefinition_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_check_adddefinition_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int mc_check_adddefinition_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_check_adddefinition_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = mc_check_adddefinition_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_check_adddefinition_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = mc_check_adddefinition_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_check_adddefinition_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_CHECK_SERVICE_NUMBER, MC_CHECK_UPDATEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_check_updatedefinition_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_check_updatedefinition_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int mc_check_updatedefinition_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_check_updatedefinition_submit_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = mc_check_updatedefinition_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  rc = mc_check_updatedefinition_submit_add_encoding_length_1(encoder,arg1,cursor);
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  mal_encoder_cursor_init(encoder, cursor, mal_message_get_body(message), mal_encoder_cursor_get_length(encoder, cursor), mal_message_get_body_offset(message));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_check_updatedefinition_submit_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = mc_check_updatedefinition_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  rc = mc_check_updatedefinition_submit_encode_1(cursor,encoder,arg1);
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_check_updatedefinition_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_CHECK_SERVICE_NUMBER, MC_CHECK_UPDATEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_check_updatedefinition_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_check_updatedefinition_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_CHECK_SERVICE_NUMBER, MC_CHECK_REMOVEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_check_removedefinition_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_check_removedefinition_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int mc_check_removedefinition_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_check_removedefinition_submit_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = mc_check_removedefinition_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_check_removedefinition_submit_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = mc_check_removedefinition_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_check_removedefinition_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_CHECK_SERVICE_NUMBER, MC_CHECK_REMOVEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_check_removedefinition_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_check_removedefinition_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
int mc_check_addparametercheck_request_decode_0(void * cursor, mal_decoder_t * decoder, mc_check_checklink_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = mc_check_checklink_list_new(0);
        if (*element_res == NULL) return -1;
        rc = mc_check_checklink_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int mc_check_addparametercheck_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MC_CHECK_CHECKLINK_LIST_SHORT_FORM);
  return rc;
}
...
int mc_check_removeparametercheck_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  if (rc < 0)
    return rc;
  // Length of arg1
  rc = mc_check_removeparametercheck_submit_add_encoding_length_1(encoder,arg1,cursor);
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  mal_encoder_cursor_init(encoder, cursor, mal_message_get_body(message), mal_encoder_cursor_get_length(encoder, cursor), mal_message_get_body_offset(message));
  ...
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  rc = mc_check_removeparametercheck_submit_encode_1(cursor,encoder,arg1);
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
...
int mc_aggregation_getvalue_request_response_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_aggregation_getvalue_request_response_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MC_AGGREGATION_AGGREGATIONVALUE_LIST_SHORT_FORM);
  return rc;
...
int mc_aggregation_getvalue_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_aggregation_getvalue_request_response_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = mc_aggregation_getvalue_request_response_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_aggregation_getvalue_request_response_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = mc_aggregation_getvalue_request_response_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_ENABLEGENERATION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_aggregation_enablegeneration_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  ...
  union mal_element_t value;
  bool presence_flag;
  rc = mc_aggregation_enablegeneration_submit_decode_0(cursor, decoder, &presence_flag, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, presence_flag);
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_BOOLEAN_SHORT_FORM);
  return rc;
...
int mc_aggregation_enablegeneration_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_aggregation_enablegeneration_submit_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, COM_INSTANCEBOOLEANPAIR_LIST_SHORT_FORM);
  return rc;
...
int mc_aggregation_enablegeneration_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_enablegeneration_submit_add_encoding_length_0(encoder,true,arg0->value.boolean_value,cursor);
  } else {
    rc = mc_aggregation_enablegeneration_submit_add_encoding_length_0(encoder,false,0,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_aggregation_enablegeneration_submit_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = mc_aggregation_enablegeneration_submit_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_enablegeneration_submit_encode_0(cursor,encoder,true,arg0->value.boolean_value);
  } else {
    rc = mc_aggregation_enablegeneration_submit_encode_0(cursor,encoder,false,0);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_aggregation_enablegeneration_submit_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = mc_aggregation_enablegeneration_submit_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_enablegeneration_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_ENABLEGENERATION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_aggregation_enablegeneration_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_enablegeneration_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_ADDDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_aggregation_adddefinition_request_decode_0(void * cursor, mal_decoder_t * decoder, mc_aggregation_aggregationdefinition_list_t ** element_res)
{
  ...
  switch (decoder->encoding_format_code)
  {
    ...
    case MALSPLITBINARY_FORMAT_CODE:
    {
      ...
      if (presence_flag)
      {
        *element_res = mc_aggregation_aggregationdefinition_list_new(0);
        if (*element_res == NULL) return -1;
        rc = mc_aggregation_aggregationdefinition_list_decode_malbinary(*element_res, decoder, cursor);
        if (rc < 0)
          return rc;
      }
      else
...
int mc_aggregation_adddefinition_request_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_aggregation_adddefinition_request_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MC_AGGREGATION_AGGREGATIONDEFINITION_LIST_SHORT_FORM);
  return rc;
}
...
int mc_aggregation_adddefinition_request_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_adddefinition_request_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = mc_aggregation_adddefinition_request_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_adddefinition_request_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = mc_aggregation_adddefinition_request_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_adddefinition_request(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_ADDDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_REQUEST, MAL_IP_STAGE_REQUEST_RESPONSE);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_aggregation_adddefinition_request_response_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_aggregation_adddefinition_request_response_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int mc_aggregation_adddefinition_request_response_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_adddefinition_request_response_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = mc_aggregation_adddefinition_request_response_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_adddefinition_request_response_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = mc_aggregation_adddefinition_request_response_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_adddefinition_request_response(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_UPDATEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_aggregation_updatedefinition_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_aggregation_updatedefinition_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int mc_aggregation_updatedefinition_submit_decode_1_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_aggregation_updatedefinition_submit_decode_1(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MC_AGGREGATION_AGGREGATIONDEFINITION_LIST_SHORT_FORM);
  return rc;
...
int mc_aggregation_updatedefinition_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0, mal_element_holder_t * arg1)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_updatedefinition_submit_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = mc_aggregation_updatedefinition_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  // Length of arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_aggregation_updatedefinition_submit_add_encoding_length_1(encoder,arg1->value.list_value,cursor);
  } else {
    rc = mc_aggregation_updatedefinition_submit_add_encoding_length_1(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_updatedefinition_submit_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = mc_aggregation_updatedefinition_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Encoding arg1
  if (arg1 != NULL && arg1->presence_flag) {
    rc = mc_aggregation_updatedefinition_submit_encode_1(cursor,encoder,arg1->value.list_value);
  } else {
    rc = mc_aggregation_updatedefinition_submit_encode_1(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_updatedefinition_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_UPDATEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_aggregation_updatedefinition_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_updatedefinition_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(init_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_REMOVEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT);
  rc = mal_endpoint_init_operation(endpoint, init_message, provider_uri, true);
  return rc;
}
...
int mc_aggregation_removedefinition_submit_decode_0_mal_element(void * cursor, mal_decoder_t * decoder, mal_element_holder_t * element_holder)
{
  int rc = 0;
  union mal_element_t value;
  rc = mc_aggregation_removedefinition_submit_decode_0(cursor, decoder, (void*)&value.composite_value);
  mal_element_holder_set_presence_flag(element_holder, ((void*)value.composite_value != NULL));
  mal_element_holder_set_value(element_holder, value);
  mal_element_holder_set_short_form(element_holder, MAL_LONG_LIST_SHORT_FORM);
  return rc;
...
int mc_aggregation_removedefinition_submit_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_uri_t * provider_uri, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name, mal_element_holder_t * arg0)
{
  ...
  // Length of arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_removedefinition_submit_add_encoding_length_0(encoder,arg0->value.list_value,cursor);
  } else {
    rc = mc_aggregation_removedefinition_submit_add_encoding_length_0(encoder,NULL,cursor);
  }
  if (rc < 0)
    return rc;
  mal_message_t *message = mal_message_new(authentication_id, qoslevel, priority, domain, network_zone, session, session_name, mal_encoder_cursor_get_length(encoder, cursor));
  ...
  // Encoding arg0
  if (arg0 != NULL && arg0->presence_flag) {
    rc = mc_aggregation_removedefinition_submit_encode_0(cursor,encoder,arg0->value.list_value);
  } else {
    rc = mc_aggregation_removedefinition_submit_encode_0(cursor,encoder,NULL);
  }
  if (rc < 0)
    return rc;
  mal_encoder_cursor_assert(encoder, cursor);
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_removedefinition_submit(endpoint, message, provider_uri);
  return rc;
}
...
{
  int rc = 0;
  mal_message_init(result_message, MC_AREA_NUMBER, MC_AREA_VERSION, MC_AGGREGATION_SERVICE_NUMBER, MC_AGGREGATION_REMOVEDEFINITION_OPERATION_NUMBER, MAL_INTERACTIONTYPE_SUBMIT, MAL_IP_STAGE_SUBMIT_ACK);
  rc = mal_endpoint_return_operation(endpoint, init_message, result_message, is_error_message);
  return rc;
}
...
int mc_aggregation_removedefinition_submit_ack_full(mal_encoder_t * encoder, mal_endpoint_t * endpoint, mal_message_t * result_message, bool is_error_message, mal_blob_t * authentication_id, mal_qoslevel_t  qoslevel, mal_uinteger_t  priority, mal_identifier_list_t * domain, mal_identifier_t * network_zone, mal_sessiontype_t  session, mal_identifier_t * session_name)
{
  ...
  // Clean
  mal_encoder_cursor_destroy(encoder, cursor);
  rc = mc_aggregation_removedefinition_submit_ack(endpoint, message, result_message, is_error_message);
  return rc;
}
