...
// structure definition for composite mc_check_checklink
struct _mc_check_checklink_t {
...
{
  mc_check_checklink_t *self = (mc_check_checklink_t *) calloc(1, sizeof(mc_check_checklink_t));
  if (!self)
    return NULL;
  return self;
}
